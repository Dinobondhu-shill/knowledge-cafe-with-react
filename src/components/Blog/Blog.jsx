...
const Blog = ({blog, handleAddToBookmarks, handleAdditionMinute}) => {
  ...
  return (
    ...
    <p>{posted_date}</p>
      ...
      <a href="#" onClick={() =>handleAdditionMinute(reading_time)} className='text-blue-700 underline font-bold'>Mark as read</a>
...
Blog.propTypes = {
  ...
  handleAdditionMinute: PropTypes.func
}
export default Blog;